...
public class SearchActivityPresenter implements SearchActivityView.UserInteractions {
            ...
            return document.select("div#questions.content-padding div.question-summary");
                ...
                .subscribe(new Observer<Elements>() {
                    ...
                    public void onComplete() {
                        mSearchActivityView.setDisplayRecyclerView(recyclerViewDataArrayList);
                        mSearchActivityView.dismissProgressDialog(subscribeProgressDialog);
                    }
                });
    }
                ...
                .subscribe(new Observer<OnOffMixData>() {
                    ...
                    public void onNext(@NonNull final OnOffMixData onOffMixData) {
                        if (onOffMixData.getError().getCode() == 0) {
                            ...
                            mSearchActivityView.dismissProgressDialog(subscribeProgressDialog);
                            mSearchActivityView.showCustomToast(onOffMixData.getError().getMessage());
                        }
                    }
    ...
    public void refreshDisplay(final String searchValue) {
        setStackOverflowData("https://stackoverflow.com/questions/tagged/" + searchValue);
        /*final String categoryCode = String.format(Locale.KOREAN, "%03d", searchValue);
        ...
        if (groupValueTitle != null) {
            if (groupValueTitle.equals(mContext.getString(R.string.etc))) {
                ...
                if (childTitle.equals(mContext.getString(R.string.stack_overflow))) {
                    ...
                    mSearchActivityView.showCustomToast(mContext.getString(R.string.load_error));
                }
            }
        }*/
    }
